...
const RAW_COUNTRIES = [
  // Americas (13)
  { n:"USA",          f:"🇺🇸", iso:"us", r:"Americas", cf:"CONCACAF", pop:"335M", rel:"Christianity", u:25, ug:["Arab Americans","Jewish Americans","Somali Americans"], cap:"Washington D.C.", lang:"English, Spanish", m:"The US hosts millions of unreached immigrants—among the world's greatest mission opportunities without leaving home.", ujp:498, ujp_unreached:92 },
  { n:"Canada",       f:"🇨🇦", iso:"ca", r:"Americas", cf:"CONCACAF", pop:"38M",  rel:"Christianity", u:18, ug:["South Asian Canadians","Chinese Canadians","Afghan refugees"], cap:"Ottawa", lang:"English, French", m:"Canada's cities are home to growing diaspora communities from least-reached nations. Gateway Cities Canada is engaging unreached diaspora peoples in cities across Canada — learn more at gatewaycities.ca", ujp:244, ujp_unreached:53 },
  { n:"Mexico",       f:"🇲🇽", iso:"mx", r:"Americas", cf:"CONCACAF", pop:"130M", rel:"Christianity", u:10, ug:["Huichol","Jewish, Spanish-speaking","Japanese"], cap:"Mexico City", lang:"Spanish", m:"Indigenous communities in southern Mexico still await contextualized gospel witness.", ujp:333, ujp_unreached:4 },
  { n:"Argentina",    f:"🇦🇷", iso:"ar", r:"Americas", cf:"CONMEBOL", pop:"46M",  rel:"Christianity", u:5,  ug:["Korean Argentines","Jewish Argentines","Syrian diaspora"], cap:"Buenos Aires", lang:"Spanish", m:"Buenos Aires holds one of Latin America's largest Jewish populations, largely unreached.", ujp:79, ujp_unreached:3 },
  { n:"Brazil",       f:"🇧🇷", iso:"br", r:"Americas", cf:"CONMEBOL", pop:"215M", rel:"Christianity", u:12, ug:["Japanese Brazilians","Lebanese Brazilians","Indigenous Amazonian"], cap:"Brasília", lang:"Portuguese", m:"Over 100 uncontacted/unreached tribal groups remain in the Amazon basin.", ujp:321, ujp_unreached:52 },
  { n:"Uruguay",      f:"🇺🇾", iso:"uy", r:"Americas", cf:"CONMEBOL", pop:"3.5M", rel:"Secular/Christianity", u:3, ug:["Lebanese diaspora","Jewish community","Korean diaspora"], cap:"Montevideo", lang:"Spanish", m:"Uruguay is one of the most secular nations in Latin America—spiritual openness is growing.", ujp:24, ujp_unreached:2 },
  { n:"Ecuador",      f:"🇪🇨", iso:"ec", r:"Americas", cf:"CONMEBOL", pop:"18M",  rel:"Christianity", u:7,  ug:["Kichwa","Shuar","Achuar"], cap:"Quito", lang:"Spanish, Kichwa", m:"Amazonian indigenous groups represent a frontier of gospel witness in Ecuador.", ujp:33, ujp_unreached:1 },
  { n:"Colombia",     f:"🇨🇴", iso:"co", r:"Americas", cf:"CONMEBOL", pop:"51M",  rel:"Christianity", u:6,  ug:["Wayuu","Nasa","Venezuelan refugees"], cap:"Bogotá", lang:"Spanish", m:"Millions of Venezuelan refugees in Colombia create an urgent gospel opportunity.", ujp:120, ujp_unreached:15 },
  { n:"Paraguay",     f:"🇵🇾", iso:"py", r:"Americas", cf:"CONMEBOL", pop:"7.4M", rel:"Christianity", u:4,  ug:["Guaraní indigenous","Guaraní, Eastern Bolivian","Chamacoco Tomaraho"], cap:"Asunción", lang:"Spanish, Guaraní", m:"The Guaraní people maintain a distinct cultural identity and are increasingly open to the gospel.", ujp:36, ujp_unreached:6 },
  { n:"Panama",       f:"🇵🇦", iso:"pa", r:"Americas", cf:"CONCACAF", pop:"4.4M", rel:"Christianity", u:5,  ug:["Ngäbe","Kuna","Chinese Panamanians"], cap:"Panama City", lang:"Spanish", m:"Panama City is a global crossroads—its diverse immigrant populations include many unreached peoples.", ujp:26, ujp_unreached:2 },
  { n:"Curaçao",      f:"🇨🇼", iso:"cw", r:"Americas", cf:"CONCACAF", pop:"151K", rel:"Christianity", u:3,  ug:["Dutch Antillean Muslims","Jewish community","Sephardic Jews"], cap:"Willemstad", lang:"Papiamentu, Dutch", m:"A tiny island with a surprising diversity of unreached communities.", ujp:16, ujp_unreached:3 },
  { n:"Haiti",        f:"🇭🇹", iso:"ht", r:"Americas", cf:"CONCACAF", pop:"11M",  rel:"Christianity/Vodou", u:4, ug:["Haitian Vodouists","Rural unreached communities","Haitian diaspora"], cap:"Port-au-Prince", lang:"Haitian Creole, French", m:"Despite a Christian majority, syncretism with Vodou affects millions spiritually.", ujp:5, ujp_unreached:1 },

  // Europe (16)
  { n:"England",      f:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", iso:"gb-eng", r:"Europe", cf:"UEFA", pop:"56M",  rel:"Christianity (nominal)", u:22, ug:["British Pakistanis","British Bangladeshis","British Somalis"], cap:"London", lang:"English", m:"London is among the world's most diverse cities—home to unreached diaspora communities from across the globe.", ujp:124, ujp_unreached:42 },
  { n:"France",       f:"🇫🇷", iso:"fr", r:"Europe", cf:"UEFA", pop:"68M",  rel:"Secular/Islam", u:28, ug:["Algerian French","Moroccan French","Turkish French"], cap:"Paris", lang:"French", m:"France hosts Europe's largest Muslim population—a mission field on Europe's doorstep.", ujp:118, ujp_unreached:41 },
  { n:"Germany",      f:"🇩🇪", iso:"de", r:"Europe", cf:"UEFA", pop:"84M",  rel:"Christianity (nominal)", u:24, ug:["Turkish Germans","Afghan Germans","Syrian Germans"], cap:"Berlin", lang:"German", m:"Post-Christian Germany has become a gateway for Muslim diaspora—ripe for cross-cultural mission.", ujp:104, ujp_unreached:38 },
  { n:"Spain",        f:"🇪🇸", iso:"es", r:"Europe", cf:"UEFA", pop:"47M",  rel:"Catholicism (nominal)", u:18, ug:["Moroccan Spanish","Romanian Roma","Sub-Saharan Africans"], cap:"Madrid", lang:"Spanish", m:"Spain's rapid secularization and growing Muslim immigrant population create new mission dynamics.", ujp:77, ujp_unreached:11 },
  { n:"Portugal",     f:"🇵🇹", iso:"pt", r:"Europe", cf:"UEFA", pop:"10M",  rel:"Catholicism (nominal)", u:14, ug:["Cape Verdean Portuguese","Brazilian Portuguese","Chinese Portuguese"], cap:"Lisbon", lang:"Portuguese", m:"Portugal's historical role as a colonial power means its diaspora communities span the globe.", ujp:35, ujp_unreached:5 },
  { n:"Netherlands",  f:"🇳🇱", iso:"nl", r:"Europe", cf:"UEFA", pop:"17.9M",rel:"Secular", u:20, ug:["Turkish Dutch","Moroccan Dutch","Surinamese Dutch"], cap:"Amsterdam", lang:"Dutch", m:"The Netherlands is one of Europe's most secular nations, with large unreached Muslim communities.", ujp:71, ujp_unreached:20 },
  { n:"Belgium",      f:"🇧🇪", iso:"be", r:"Europe", cf:"UEFA", pop:"11.6M",rel:"Secular/Catholicism", u:19, ug:["Moroccan Belgians","Turkish Belgians","Congolese Belgians"], cap:"Brussels", lang:"French, Dutch, German", m:"Brussels, seat of the EU, houses some of Europe's most unreached immigrant populations.", ujp:56, ujp_unreached:27 },
  { n:"Croatia",      f:"🇭🇷", iso:"hr", r:"Europe", cf:"UEFA", pop:"3.9M", rel:"Catholicism", u:8,  ug:["Bosnian Muslims","Roma Croatians","Serbian minority"], cap:"Zagreb", lang:"Croatian", m:"The Western Balkans remain a frontier for Protestant gospel witness in post-communist Europe.", ujp:17, ujp_unreached:3 },
  { n:"Austria",      f:"🇦🇹", iso:"at", r:"Europe", cf:"UEFA", pop:"9.1M", rel:"Catholicism (nominal)", u:16, ug:["Turkish Austrians","Chechen refugees","Afghan Austrians"], cap:"Vienna", lang:"German", m:"Vienna serves as a crossroads for refugees from Muslim-majority nations.", ujp:46, ujp_unreached:13 },
  { n:"Scotland",     f:"🏴󠁧󠁢󠁳󠁣󠁴󠁿", iso:"gb-sct", r:"Europe", cf:"UEFA", pop:"5.5M", rel:"Christianity (nominal)", u:10, ug:["Pakistani Scots","South Asian Scots","Chinese Scots"], cap:"Edinburgh", lang:"English, Scottish Gaelic", m:"Scotland's post-Christian landscape is spiritually open yet deeply nominally Christian.", ujp:124, ujp_unreached:42 },
  { n:"Norway",       f:"🇳🇴", iso:"no", r:"Europe", cf:"UEFA", pop:"5.4M", rel:"Christianity (nominal)", u:13, ug:["Pakistani Norwegians","Somali Norwegians","Iraqi Norwegians"], cap:"Oslo", lang:"Norwegian", m:"Norway's generosity to refugees has created a multi-cultural mission field in Scandinavian cities.", ujp:53, ujp_unreached:17 },
  { n:"Switzerland",  f:"🇨🇭", iso:"ch", r:"Europe", cf:"UEFA", pop:"8.7M", rel:"Secular/Christianity", u:17, ug:["Turk","Bosniak","Arab, Syrian"], cap:"Bern", lang:"German, French, Italian", m:"Geneva and Zurich host international communities from least-reached nations.", ujp:58, ujp_unreached:17 },
  { n:"Bosnia & Herzegovina", f:"🇧🇦", iso:"ba", r:"Europe", cf:"UEFA", pop:"3.5M", rel:"Islam/Christianity", u:5, ug:["Bosniak","Roma Bosnians","Albanian Muslims"], cap:"Sarajevo", lang:"Bosnian, Serbian, Croatian", m:"Bosnia is home to Europe's most established Muslim community — and a Bosniak diaspora scattered across the US, Germany, and Austria after the 1990s war. The scars of the 1990s war run deep across Bosnian society — making the gospel of reconciliation uniquely compelling in this context.", diaspora:"🌎 Tens of thousands of Bosniaks have settled in North America, with a significant community in St. Louis. [Meet them at UPG North America →](https://upgnorthamerica.com/project/bosniaks-in-north-america/)", ujp:8, ujp_unreached:3 },
  ...
  { n:"Ghana",        f:"🇬🇭", iso:"gh", r:"Africa", cf:"CAF", pop:"33M",  rel:"Christianity/Islam", u:10, ug:["Hausa","Frafra","Wala"], cap:"Accra", lang:"English, Akan, Hausa", m:"Ghana's Muslim north remains largely unreached, while its diaspora communities are growing across North America and Europe.", dia:"Significant Ghanaian communities in New York, London, and Toronto.", ujp:108, ujp_unreached:16 },
  { n:"DR Congo",     f:"🇨🇩", iso:"cd", r:"Africa", cf:"CAF", pop:"100M", rel:"Christianity", u:18, ug:["Mongo","Luba","Kongo"], cap:"Kinshasa", lang:"French, Lingala, Swahili", m:"The DRC is home to more unreached people groups than any other African nation — many in remote river communities with no gospel access.", dia:"Growing Congolese diaspora in Montreal, Brussels, and several US cities.", ujp:231, ujp_unreached:4 },
  { n:"Cabo Verde",   f:"🇨🇻", iso:"cv", r:"Africa", cf:"CAF", pop:"560K", rel:"Christianity", u:2,  ug:["Cape Verdean Creole","West African migrants","Returning diaspora"], cap:"Praia", lang:"Portuguese, Cape Verdean Creole", m:"Cabo Verde is majority Christian but serves as a migration hub — its diaspora is scattered across Portugal, the Netherlands, and New England.", dia:"One of the largest diaspora-to-home-population ratios in the world; strong Cape Verdean community in Boston and Providence.", ujp:5, ujp_unreached:2 },

  // Asia (9)
  { n:"Japan",        f:"🇯🇵", iso:"jp", r:"Asia", cf:"AFC", pop:"125M", rel:"Buddhism/Shinto", u:16, ug:["Japanese Buddhists","Korean Japanese","Zainichi Koreans"], cap:"Tokyo", lang:"Japanese", m:"Japan is often called one of the world's hardest mission fields—less than 1% Christian after 150 years of mission.", ujp:43, ujp_unreached:28 },
  { n:"South Korea",  f:"🇰🇷", iso:"kr", r:"Asia", cf:"AFC", pop:"52M",  rel:"Christianity/Buddhism", u:9,  ug:["Korean Buddhists","Chinese Koreans","Southeast Asian migrants"], cap:"Seoul", lang:"Korean", m:"South Korea has become a major missionary-sending nation—over 20,000 Korean missionaries serve globally. And yet the nation most on the hearts of South Korean believers — North Korea — remains one of the world's most closed and unreachable.", ujp:30, ujp_unreached:13 },
  ...
  { n:"Saudi Arabia", f:"🇸🇦", iso:"sa", r:"Asia", cf:"AFC", pop:"35M",  rel:"Islam", u:10, ug:["Arab, Saudi - Najdi","Arab, Saudi - Hijazi","Arab, Bedouin"], cap:"Riyadh", lang:"Arabic", m:"The birthplace of Islam—yet Saudi Arabia has seen a remarkable wave of Saudis turning to Christ.", diaspora:"🌎 Saudi Arabs are present across North America, often in university cities and major metros. [Meet them at UPG North America →](https://upgnorthamerica.com/project/saudi-arabs-in-north-america/)", ujp:57, ujp_unreached:43 },
  { n:"Australia",    f:"🇦🇺", iso:"au", r:"Asia", cf:"AFC", pop:"26M",  rel:"Christianity (nominal)", u:19, ug:["Chinese Australians","Lebanese Australians","Afghan Australians"], cap:"Canberra", lang:"English", m:"Australia's cities are home to growing diaspora communities from Southeast Asia and the Middle East.", ujp:208, ujp_unreached:41 },
  ...
  { n:"Qatar",        f:"🇶🇦", iso:"qa", r:"Asia", cf:"AFC", pop:"2.9M", rel:"Islam", u:5,  ug:["Arab, Arabic Gulf Spoken","Arab, Palestinian","Persian"], cap:"Doha", lang:"Arabic", m:"Qatar's migrant worker population (over 85% of residents) includes many unreached South Asians.", ujp:25, ujp_unreached:14 },
  { n:"Iraq",         f:"🇮🇶", iso:"iq", r:"Asia", cf:"AFC", pop:"41M",  rel:"Islam", u:22, ug:["Yazidis","Arab, Iraqi","Kurd, Sorani"], cap:"Baghdad", lang:"Arabic, Kurdish", m:"Iraq's Yazidi and Kurdish peoples have faced devastating persecution — yet both communities show remarkable openness to the gospel in the aftermath of trauma. Iraq is a nation marked by suffering — and by an unexpected openness that suffering has created.", diaspora:"🌎 Over 200,000 Iraqi Arabs live in North America — with the largest community in the Detroit metro area. [Meet them at UPG North America →](https://upgnorthamerica.com/project/iraqi-arabs-in-north-america/)", ujp:33, ujp_unreached:27 },

  // Oceania (1)
  { n:"New Zealand",  f:"🇳🇿", iso:"nz", r:"Oceania", cf:"OFC", pop:"5.1M", rel:"Christianity (nominal)", u:9, ug:["Māori","Pacific Islander NZ","Chinese New Zealanders"], cap:"Wellington", lang:"English, Māori", m:"New Zealand's Māori people are experiencing revival—and Polynesian churches are sending missionaries across the Pacific.", ujp:60, ujp_unreached:19 },
];
