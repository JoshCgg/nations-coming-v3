...
const RAW_COUNTRIES = [
  ...
  { n:"Türkiye",      f:"🇹🇷", r:"Europe", cf:"UEFA", pop:"85M",  rel:"Islam", u:30, ug:["Kurds","Alevis","Laz"], cap:"Ankara", lang:"Turkish, Kurdish", m:"Turkey is home to 30+ unreached people groups including 15 million Alevis — a distinct Muslim sect with little gospel witness. The church in Turkey is tiny but growing.", dia:"Large Turkish diaspora in Germany, Netherlands, and Belgium; growing Turkish communities in several US cities." },
  ...
  { n:"Iraq",         f:"🇮🇶", r:"Asia", cf:"AFC", pop:"41M",  rel:"Islam", u:22, ug:["Iraqi Arabs","Kurds","Yazidis"], cap:"Baghdad", lang:"Arabic, Kurdish", m:"Iraq's Yazidi and Kurdish peoples have faced devastating persecution — yet both communities show remarkable openness to the gospel in the aftermath of trauma.", dia:"Significant Iraqi diaspora in Detroit, Nashville, and San Diego — one of the largest Iraqi populations outside the Middle East is in metro Detroit." },
